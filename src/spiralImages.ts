...
import neonSpiralImg from '/public/spirals/neon_spiral.png';
import squareSpiralImg from '/public/spirals/square_spiral.png';
...
export const spiralImages = isDevelopment 
  ? [offsetSpiralImg, xmapSpiralImg, neonSpiralImg, squareSpiralImg]  
  : [
